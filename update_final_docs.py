...
docx_path = r"C:\Users\HomePC\.gemini\antigravity\scratch\novapulse-ai\Task_13_Submission_NovaPulse_AI_anuu7.docx"
doc.save(docx_path)
print(f"Updated DOCX saved to: {docx_path}")
